  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '22px', display: 'flex', flexDirection: 'column', gap: '10px', flex: 1 }}>
        ...
        {/* Description */}
        <p style={{ fontSize: '0.9rem', lineHeight: 1.75, color: 'var(--text-soft)', flex: 1 }}>
          {project.summary}
        </p>
        ...
        <div style={{ display: 'flex', gap: '10px', paddingTop: '14px', borderTop: '1px solid var(--border)' }}>
          <a
            ...
            style={{ padding: '9px 14px', fontSize: '0.82rem', borderRadius: '8px', flex: 1, justifyContent: 'center' }}
          >
      ...
      {others.length > 0 && (
        <div style={{ marginTop: '32px' }}>
          <button
            ...
            className="btn-secondary"
            style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: '0 auto', padding: '10px 22px', fontSize: '0.88rem' }}
          >
